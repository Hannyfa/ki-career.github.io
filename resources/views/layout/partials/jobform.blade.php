        ...
        <div class="modal-content p-3">
            <div class="modal-header p-2 align-items-start">
                <div class="d-flex flex-column justify-content-center w-100 align-items-center">
                    <img src="{{ url('img/altie.png') }}" width="50px" alt="Al Ittihad" class="">
            ...
            <div class="modal-body">
                <form action="">
                    ...
                    <div class="mb-3">
                        <label for="massage-text" class="col-form-label">Tunjangan & Keuntungan</label>
                    ...
                    <div class="mb-3">
                        <label for="massage-text" class="col-form-label">Skill yang harus dikuasai</label>
                        ...
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="" id="flexCheckChecked">
                                    <label class="form-check-label" for="flexCheckChecked">Professional bersertifikasi</label>
                                </div>
                            </div>
                        </div>
                        <div class="col">
