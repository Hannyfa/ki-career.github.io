...
@section('content')
            ...
            <div>
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" active><a href="/lowongan/detail">Detail Lowongan</a>
    ...
    <div class="mx-5 mt-4">
        <p>Cari pekerjaan yang cocok untuk anda</p>
    </div>
    <div class="d-flex mt-2 px-5">
        ...
        <div>
        <button class="rounded-pill px-5 py-3 bg-primary btn text-white" style="widht:350px" data-bs-toggle="modal" data-bs-target="#formModal"><i class="fas fa-plus me-2">Tambah Lowongan</i></button>
        <div class="mt-5 p-4 bg-light rounded">
            ...
            <form action="" class="mt-3">
                ...
                <div class="mb-2">
                    ...
                    <div class="form-check mb-2">
                        <input class="form-check-input" type="checkbox" name="" value="" id="flexCheckChecked">
                        <label class="form-check-label" for="flexCheckChecked">Akuntansi & Keuangan</label>
                    </div>
                </div>
            </form>
        </div>
